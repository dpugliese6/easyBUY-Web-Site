...
<head>
	...
	<title>Crea lista - easyBUY</title>
...
<body>
	<div class="wrapper">
		<div class="sticky">
			<div class="stickydiv">
				<a href="liste.php" style="float:left;" class="sticky-right">
		...
		<div class="crealista">
			...
			<form method="post" action="#">
				<div class="campo">
					<input type="text" name="creare" required style="width: 100%; max-width:300px; margin:0 20px;" placeholder="Nome lista">
					<?php if ($_POST) {
						$DBhost = "localhost";
						$DBName = "my_easybuy20";
						...
						$mail = $_COOKIE['u'];
						$nome = $_POST['creare'];
						$sqlquery = "INSERT INTO `LISTA` (`Nome`) VALUES ( '$nome');";
						mysql_query($sqlquery);
						$sqlquery = "INSERT INTO `LISTA_UTENTE` (`Id_lista`,`Email`) VALUES ((SELECT MAX(Id_lista) FROM LISTA LIMIT 1), '$mail');";
						mysql_query($sqlquery);
						echo " <br>
										<br>
										<center><h3 style='color: green;'>Lista creata correttamente!</h3></center>
										";
					} ?>
				</div>
				<div class="tasto">
