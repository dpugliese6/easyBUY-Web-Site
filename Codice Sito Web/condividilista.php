...
<head>
	...
	<title>Condividi lista - easyBUY</title>
			...
			<form method="post" action="#">
				<div class="campo">
					...
					if ($_POST) {           //Se viene eseguita una POST request
						...
						$lista = $_COOKIE['list'];               //Estrapolo l'id lista dal cookie
						...
						if (mysql_num_rows($result) < 1) {            //Se non ci sono utenti con quella mail
							...
							$sqlquery = "INSERT INTO `LISTA_UTENTE` (`Id_lista`,`Email`) VALUES ('$lista', '$utente');";         //Inserisco quel carrello all'utente con cui condividere
							mysql_query($sqlquery);
							echo "
                                        <br>
										<br>
										<center><h3 style='color: green;'>Lista condivisa correttamente!</h3></center>
										";
						}
					}
					?>
